...
//                  color: Color(0xFF515C6F),
          ...
          Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                buildViewCard("Vivo V11", "\$11.00", 'assets/images/vivo.jpg'),
                buildViewCard("OPPO k3", "\$20.58", 'assets/images/oppo.jpg'),
              ],
            ),
          ),
          Row(
...
//                      color: Colors.white),
//                  padding:
//                      EdgeInsets.only(top: 15, left: 15, bottom: 10, right: 10),
//                  child: Column(
...
//                              fontSize: 14)),
//                      Text(
//                        searchDataList.elementAt(index).price,
//                        style: TextStyle(
//                          fontFamily: 'NeusaNextPro',
